...
// Los iconos son decorativos: el texto accesible lo pone el botón o el enlace
// que los contiene (aria-label). Marcarlos aria-hidden evita que un lector de
// pantalla lea ruido, y focusable="false" que el tabulador entre en el SVG en
// algunos navegadores. Va antes de {...props} para poder sobreescribirlo.

const ICON_SIZE = 24;

export const IconVinyl = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" width={ICON_SIZE} height={ICON_SIZE} aria-hidden="true" focusable="false" {...props}>
...
export const IconEuro = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" width={ICON_SIZE} height={ICON_SIZE} aria-hidden="true" focusable="false" {...props}>
    <path d="M4 10A8 8 0 1 0 4 14M2 13h9M2 11h9" />
  </svg>
);

export const IconPlay = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 24 24" fill="currentColor" width={ICON_SIZE} height={ICON_SIZE} aria-hidden="true" focusable="false" {...props}>
...
export const IconArrowUp = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" width={ICON_SIZE} height={ICON_SIZE} aria-hidden="true" focusable="false" {...props}>
